...
/**
 * Options control behaviors specific to the SplunkTracing tracer.
 */
public final class Options {
     ...
     */
    private static final String DEFAULT_COLLECTOR_HOST = "127.0.0.1";

    /**
     * Default collector port for HTTPS
     */
    static final int DEFAULT_SECURE_PORT = 8088;

    /**
     * Default collector port for HTTP
     */
    static final int DEFAULT_PLAINTEXT_PORT = 8088;
    ...
    long getGuid() {
        return (long) tags.get(SplunkTracingConstants.Tags.GUID_KEY);
    }
    ...
    public static class OptionsBuilder {
         ...
         * doubt, contact SplunkTracing for advice.
         *
         ...
         *
         * @param accessToken Your specific token for SplunkTracing access.
         */
         ...
         * primary SplunkTracing collector address.
         *
         * @param collectorHost The hostname for the SplunkTracing collector.
         ...
         *
         * @param collectorPort The port for the SplunkTracing collector.
         ...
         *
         * @param scopeManager The scopeManager for the SplunkTracing tracer.
        ...
        public OptionsBuilder withComponentName(String name) {
            return withTag(SplunkTracingConstants.Tags.COMPONENT_NAME_KEY, name);
        }
         ...
         * which bounds the memory usage of the SplunkTracing library.
         *
        ...
        /**
         * Disables SplunkTracing Meta Event Reporting
         * even if a server command requested it.
    ...
    public OptionsBuilder withClockSkewCorrection(boolean clockCorrection) {
        ...
        private void defaultGuid() {
            if (tags.get(SplunkTracingConstants.Tags.GUID_KEY) == null) {
                withTag(SplunkTracingConstants.Tags.GUID_KEY, Util.generateRandomGUID());
            }
        }
        ...
        private void defaultComponentName() {
            if (tags.get(SplunkTracingConstants.Tags.COMPONENT_NAME_KEY) == null) {
