...
import static com.splunk.tracer.shared.Options.VERBOSITY_ERRORS_ONLY;
...
import static com.splunk.tracer.shared.Options.VERBOSITY_NONE;
...
public class GrpcAbstractTracerTest {
    ...
    private com.splunk.tracer.shared.SpanContext spanContext;

    @Before
    public void setup() {
        Map<String, String> baggage = Collections.singletonMap(BAGGAGE_KEY, BAGGAGE_VALUE);
        spanContext = new com.splunk.tracer.shared.SpanContext(TRACE_ID, SPAN_ID, baggage);
    }
    ...
    public void testGenerateTraceURL() throws Exception {
        ...
        String expectedUrlStart = "https://app.splunk.com/" + ACCESS_TOKEN + "/trace?span_guid="
