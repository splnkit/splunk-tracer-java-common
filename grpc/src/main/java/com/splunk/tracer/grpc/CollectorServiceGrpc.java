package com.splunk.tracer.grpc;
...
public class CollectorServiceGrpc {
  ...
  public static final String SERVICE_NAME = "splunk.collector.CollectorService";


  // Static method descriptors that strictly reflect the proto.
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.splunk.tracer.grpc.ReportRequest,
      com.splunk.tracer.grpc.ReportResponse> METHOD_REPORT =
      io.grpc.MethodDescriptor.create(
          io.grpc.MethodDescriptor.MethodType.UNARY,
          generateFullMethodName(
              "splunk.collector.CollectorService", "Report"),
          io.grpc.protobuf.ProtoUtils.marshaller(com.splunk.tracer.grpc.ReportRequest.getDefaultInstance()),
          io.grpc.protobuf.ProtoUtils.marshaller(com.splunk.tracer.grpc.ReportResponse.getDefaultInstance()));
  ...
  public static abstract class CollectorServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void report(com.splunk.tracer.grpc.ReportRequest request,
        io.grpc.stub.StreamObserver<com.splunk.tracer.grpc.ReportResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.splunk.tracer.grpc.ReportRequest,
                com.splunk.tracer.grpc.ReportResponse>(
  ...
  public static final class CollectorServiceBlockingStub extends io.grpc.stub.AbstractStub<CollectorServiceBlockingStub> {
    ...
    /**
     */
    public com.splunk.tracer.grpc.ReportResponse report(com.splunk.tracer.grpc.ReportRequest request) {
  ...
  public static final class CollectorServiceFutureStub extends io.grpc.stub.AbstractStub<CollectorServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.splunk.tracer.grpc.ReportResponse> report(
        com.splunk.tracer.grpc.ReportRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_REPORT:
          serviceImpl.report((com.splunk.tracer.grpc.ReportRequest) request,
              (io.grpc.stub.StreamObserver<com.splunk.tracer.grpc.ReportResponse>) responseObserver);
          break;
        default:
  ...
  private static final class CollectorServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.splunk.tracer.grpc.Collector.getDescriptor();
    }
  }
